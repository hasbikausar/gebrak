<?php
  ...
  $artikel = $db_link->query("SELECT * FROM artikel WHERE isi LIKE '%$_POST[kata]%' ORDER by id_artikel DESC LIMIT $posisi, $batas")
...
?>
  ...
  <p>
    <?php if ($data['gambar'] != " ");?>
    <img src="img/artikel/<?php echo $data['gambar']; ?>" class="responsive-img" id="gambar-artikel">
    <p>
    <?php echo $isi; ?> ...
    <a href="?tampil=artikel_detail&id=<?php echo $data['id_artikel']; ?>">See more</a>
  </p>
<?php
  }
