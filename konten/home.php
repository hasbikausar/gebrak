<?php
  ...
  $berita = $db_link->query("SELECT * FROM berita ORDER by id_berita DESC LIMIT $posisi, $batas")
...
<?php
  ...
  if($pages > 1){
		echo "<a  href='?tampil=home&pages=1' class='tooltipped' data-position='top' data-delay='50' data-tooltip='First'> <i class='material-icons'>first_page</i> </a>";
		echo "<a href='?tampil=home&pages=$previous' class='tooltipped' data-position='top' data-delay='50' data-tooltip='Previous'> <i class='material-icons'>chevron_left</i> </a>";
	}else{
	...
	if($pages < $jmlpages){
		echo "<a href='?tampil=home&pages=$next' class='tooltipped' data-position='top' data-delay='50' data-tooltip='Next'> <i class='material-icons'>chevron_right</i> </a>";
		echo "<a href='?tampil=home&pages=$jmlpages' class='tooltipped' data-position='top' data-delay='50' data-tooltip='Last'> <i class='material-icons'>last_page</i> </a>";
	}else{
